                                ...
                                <tr>
                                    ...
                                    <td class="px-6 py-3 whitespace-nowrap">
                                        <div class="flex items-center">
                                            <div class="flex items-center gap-3">
                                                <div>
                                                    <img src="{{ $row->image ? asset('uploads/about/' . $row->image) : asset('img/default-banner.jpg')  }}" alt="About Image"
