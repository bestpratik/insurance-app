<x-app-layout>
    ...
    <div
        ...
        <form class="bg-white w-full space-y-4" method="post" action="{{ route('update.about', $about->id) }}"
            ...
            <div>
                <label class="block">
                    ...
                    <input name="sub_title" type="text" class="w-full mt-1 p-2 border rounded"
                        value="{{ $about->sub_title }}" placeholder="Enter Sub Title">
                </label>
            </div>
            ...
            <div>
                <label class="block">
                    ...
                    <small class="text-gray-500 block mt-1">Recommended size: 800×600px</small>
                    <input name="image" type="file" onchange="loadFile(event)"
                        class="w-full mt-1 p-2 border rounded">
                </label>
                <div class="shrink-0">
                    <img id='preview_img' class="h-16 w-16 object-cover rounded-full"
                        src="{{ asset('uploads/about/' . $about->image) }}" alt="Current photo" />
                </div>
            </div>
