<x-app-layout>
    ...
    <div
        ...
        <form class="bg-white w-full space-y-4" method="post" action="{{ route('update.faq', $faqs->id) }}"
            ...
            <div>
                <label class="block">Answer
                    <span class="text-red-700">*</span>
                    <textarea name="answer" id="summernote" type="text" class="w-full mt-1 p-2 border rounded summernote"
                        placeholder="Enter Answer">{{ old('answer', $faqs->answer) }}</textarea>
