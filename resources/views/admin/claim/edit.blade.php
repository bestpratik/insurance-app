<x-app-layout>
    ...
    <div
        ...
        <form class="bg-white w-full space-y-4" method="post" action="{{ route('update.claim', $claim->id) }}"
            ...
            <div>
                <label class="block">
                    ...
                    <input name="title" type="text" class="w-full mt-1 p-2 border rounded"
                        value="{{ $claim->title }}" placeholder="Enter Title">
                </label>
            </div>
            ...
            <div>
                <label class="block">
                    ...
                    <textarea name="description" id="summernote" type="text" class="w-full mt-1 p-2 border rounded summernote"
                        placeholder="Enter Description">{{ old('description', $claim->description) }}</textarea>
                </label>
            </div>
