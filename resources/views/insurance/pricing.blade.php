                ...
                <form class="p-3 md:px-6 md:pb-6 w-full space-y-4" method="post" action="{{route('insurance.pricing.submit', $insurance->id)}}"
                    ...
                    <div class="grid grid-cols-1 lg:grid-cols-3 gap-4">
                        ...
                        <label class="block">
                            ...
                            <input name="gross_premium" type="text" class="w-full mt-1 p-2 border border-[#66666660]  rounded" placeholder="Gross Premium = Net Premium + Commission" value="{{$insurance->gross_premium}}" readonly>
                        </label>

                        <label class="block">
                            <span class="text-gray-700">IPT <span class="text-gray-500" style="font-size: 12px;">(12% of Gross Premium)</span> </span>
                            <input name="ipt" type="text" class="w-full mt-1 p-2 border border-[#66666660] rounded" placeholder="Enter name" value="{{$insurance->ipt}}" readonly>
                        </label>

                        <label class="block">
                            <span class="text-gray-700">Total Premium</span>
                            <input name="total_premium" type="text" class="w-full mt-1 p-2 border border-[#66666660] rounded" placeholder="Enter name" value="{{$insurance->total_premium}}" readonly>
                        </label>
