<div class="mt-5">
    ...
    <div class="bg-white rounded-lg p-6 shadow overflow-hidden">
        ...
        <div class="sm:w-64 my-3">
            ...
            <select wire:model.live="perPage" class="pbg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 inline min-w-[60px] py-1">
