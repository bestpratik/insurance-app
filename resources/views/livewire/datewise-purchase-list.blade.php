<div class="p-4">
    ...
    <div class="bg-white rounded-lg shadow overflow-hidden">
        ...
        <div class="flex flex-col md:flex-row md:items-center md:justify-between gap-4 p-4 border-b">
            ...
            <div>
                ...
                <p class="text-sm text-gray-500">
                    View, filter and export purchase transactions.
                </p>
            </div>
            ...
            <div class="flex items-center gap-3">
                ...
                <button wire:click="export" wire:loading.attr="disabled"
                    class="inline-flex items-center gap-2 rounded-lg bg-emerald-600 hover:bg-emerald-700 text-white px-4 py-2.5 text-sm font-semibold shadow transition">
