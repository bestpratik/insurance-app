        ...
        <div class="max-w-7xl mx-auto rounded-md p-2">
            <div class="relative">
                ...
                <div id="tabWrapper" class="overflow-x-auto no-scrollbar">
                    <nav id="tabMenu"
                        class="flex justify-center whitespace-nowrap space-x-1 md:space-x-2 border-b px-6 py-2">
                        <!-- Tab Button Template -->
                            ...
                            <div class="flex space-x-5">
                                <label class="flex items-center space-x-2 px-3 py-1 rounded-full bg-[#66666610]">
                                    <input type="radio" wire:model="productType"
                                        class="text-blue-600 focus:ring-blue-500" value="I’m an Landlord">
                                    <span>I’m a Landlord</span>
                                </label>
                                <label class="flex items-center space-x-2 px-3 py-1 rounded-full bg-[#66666610]">
                                    <input type="radio" wire:model="productType"
                                        class="text-blue-600 focus:ring-blue-500" value="I’m an Agent">
                        ...
                        <div>
                            ...
                            <div class="flex items-center space-x-6">
                                <label for="homeemergency" class="flex items-center space-x-2">
                                    <input id="homeemergency" type="checkbox" wire:model="insurancesRequired"
                                        value="Home Emergency" class="text-blue-600 focus:ring-blue-500">
                                    <span>Home Emergency</span>
                                </label>

                                <label for="maliciousdamage" class="flex items-center space-x-2">
                                    <input id="maliciousdamage" type="checkbox" wire:model="insurancesRequired"
                                        value="Malicious Damage/Contents" class="text-blue-600 focus:ring-blue-500">
                        ...
                        <div class="grid md:grid-cols-3 gap-4">
                            <div class="mb-2">
                                ...
                                <div class="flex items-center space-x-4">
                                    <div>
                                        <input type="radio" id="typeOfinsurancenew" wire:model="insuranceType"
                                            wire:click="setInsuranceType('new')" value="new">
                                        <label for="typeOfinsurancenew">New</label>
                                    </div>

                                    <div>
                                        <input type="radio" id="typeOfinsurancerenewal" wire:model="insuranceType"
                                            wire:click="setInsuranceType('renewal')" value="renewal">
                            ...
                            @if ($insuranceType === 'renewal')
                                <div class="col-md-12 mt-3">
                                    <div class="form-group">
                                        <label class="block font-semibold mb-1">
                                            Do you have any rent arrears in past 12 months? <span
                                                class="text-red-600">*</span>
                                        </label>
                                        <div class="flex items-center space-x-6 mt-2">
                                            <div class="flex items-center">
                                                <input wire:model="rentArrears" id="arrears_yes" type="radio"
                                                    value="Yes" class="mr-1">
                                                <label for="arrears_yes">Yes</label>
                                            </div>
                                            <div class="flex items-center">
                                                <input wire:model="rentArrears" id="arrears_no" type="radio"
                                                    value="No" class="mr-1">
                        ...
                        <div class="grid md:grid-cols-3 gap-4">
                            @if (is_array($insurancesRequired) && in_array('Malicious Damage/Contents', $insurancesRequired))
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                    <div class="mb-2">
                                        <label class="block mb-1">Year of Purchase <span
                                    ...
                                    <div class="mb-2">
                                        <label class="block mb-1">Year of Build <span
                                                class="text-red-600">*</span></label>
                            ...
                            <div class="mb-2">
                                ...
                                <select wire:model="noOfBedrooms"
                                    class="w-full p-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500">
            ...
            @if ($currentStep === 6)
                <div id="tab6" class="tab-content bg-white p-6 rounded shadow">
                    <div class="space-y-4 mt-6">
                        <p class="font-semibold text-gray-800 text-lg mb-1">Council Details <span
                                class="text-danger">*</span></p>

                        <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                            <div>
                                <label class="block text-sm font-medium text-gray-700">Council Name<span
                                        class="text-red-600">*</span></label>
                                <input type="text"
                                    class="mt-1 py-1.5 px-2 block w-full border border-gray-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500"
                            ...
                            <div>
                                <label class="block text-sm font-medium text-gray-700">Council Officer Name<span
                                        class="text-red-600">*</span></label>
                                <input type="text"
                                    class="mt-1 py-1.5 px-2 block w-full border border-gray-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500"
                            ...
                            <div>
                                <label class="block text-sm font-medium text-gray-700">Council Officer Email<span
                                        class="text-red-600">*</span></label>
                                <input type="email"
                                    class="mt-1 py-1.5 px-2 block w-full border border-gray-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500"
                ...
                <div class="bg-gray-50 p-6 rounded-2xl shadow-xl border border-gray-200 space-y-8">
                    ...
                    <div class="bg-white p-5 rounded-xl shadow-sm border border-gray-200">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-3 text-gray-600">
                            ...
                            <p><span class="font-medium">Selected Insurance:</span>
                                {{ $insuranceDetails->name ?? 'N/A' }}</p>
                    ...
                    <div class="bg-white p-5 rounded-xl shadow-sm border border-gray-200">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-3 text-gray-600">
                            ...
                            @if ($policyholderFirstName || $policyholderLastName)
                                <p><span class="font-medium">Name:</span> {{ $policyholderTitle }}
                                    {{ $policyholderFirstName }} {{ $policyholderLastName }}</p>
                            @endif
                            <p><span class="font-medium">Contact Email:</span>
                                {{ $policyholderEmail ?? $policyholderCompanyEmail }}</p>
                            <p><span class="font-medium">Contact Phone:</span> {{ $policyholderPhone }}</p>
                            @if ($policyholderAlternativePhone)
                                <p><span class="font-medium">Alternate Phone:</span>
                                    {{ $policyholderAlternativePhone }}</p>
                            @endif
