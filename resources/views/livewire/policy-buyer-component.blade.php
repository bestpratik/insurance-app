        ...
        <div class="max-w-7xl mx-auto rounded-md p-2">
                    ...
                    <nav id="tabMenu" class="flex whitespace-nowrap space-x-1 md:space-x-2 border-b px-6 py-2">
                        ...
                        <a href="#" data-tab="tab1"
                            class="tab-btn flex items-center text-center px-4 py-2 font-medium 
                                @if ($currentStep === 1) border-b-2 border-red-500 text-red-600
                                @else
                                    text-gray-600 hover:text-red-600 hover:border-b-2 hover:border-red-500 @endif">
                        ...
                        <a href="#" data-tab="tab2"
                            class="tab-btn flex items-center text-center px-4 py-2 font-medium 
                                @if ($currentStep === 2) border-b-2 border-red-500 text-red-600
                                @else
                                    text-gray-600 hover:text-red-600 hover:border-b-2 hover:border-red-500 @endif">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                                stroke-width="1.5" stroke="currentColor" class="size-6">
                        ...
                        <a href="#" data-tab="tab3"
                            class="tab-btn flex items-center text-center px-4 py-2 font-medium 
                                @if ($currentStep === 3) border-b-2 border-red-500 text-red-600
                                @else
                                    text-gray-600 hover:text-red-600 hover:border-b-2 hover:border-red-500 @endif">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                                stroke-width="1.5" stroke="currentColor" class="size-6">
                        ...
                        <a href="#" data-tab="tab4"
                            class="tab-btn flex items-center text-center px-4 py-2 font-medium 
                                @if ($currentStep === 4) border-b-2 border-red-500 text-red-600
                                @else
                                    text-gray-600 hover:text-red-600 hover:border-b-2 hover:border-red-500 @endif">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                                stroke-width="1.5" stroke="currentColor" class="size-6">
                        ...
                        <a href="#" data-tab="tab5"
                            class="tab-btn flex items-center text-center px-4 py-2 font-medium 
                                @if ($currentStep === 5) border-b-2 border-red-500 text-red-600
                                @else
                                    text-gray-600 hover:text-red-600 hover:border-b-2 hover:border-red-500 @endif">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                                stroke-width="1.5" stroke="currentColor" class="size-6">
                        ...
                        <!-- <a href="#" data-tab="tab6"
                            class="tab-btn flex items-center text-center px-4 py-2 font-medium 
                                @if ($currentStep === 6) border-b-2 border-red-500 text-red-600
                                @else
                                    text-gray-600 hover:text-red-600 hover:border-b-2 hover:border-red-500 @endif">
                        ...
                        <a href="#" data-tab="tab7"
                            class="tab-btn flex items-center text-center px-4 py-2 font-medium 
                                @if ($currentStep === 7) border-b-2 border-red-500 text-red-600
                                @else
                                    text-gray-600 hover:text-red-600 hover:border-b-2 hover:border-red-500 @endif">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                                stroke-width="1.5" stroke="currentColor" class="size-6">
            ...
            @if ($currentStep === 1)
                <div id="tab1" class="tab-content bg-white p-6 rounded shadow">
                    ...
                    @if ($selectedInsuranceName === 'Landlord Legal Expenses & Rent Guarantee Insurance - MW')
                            ...
                            <div>
                                ...
                                <div class="flex space-x-5">
                                    <label class="flex items-center space-x-2 px-3 py-1 rounded-full bg-[#66666610]">
                                        <input type="radio" wire:model="productType"
                                            class="text-blue-600 focus:ring-blue-500" value="Landlord">
                                        <span>Landlord</span>
                                    </label>
                                    <label class="flex items-center space-x-2 px-3 py-1 rounded-full bg-[#66666610]">
                                        <input type="radio" wire:model="productType"
                                            class="text-blue-600 focus:ring-blue-500" value="Agent">
                                        <span>Agent</span>
                                    </label>
                                    <label class="flex items-center space-x-2 px-3 py-1 rounded-full bg-[#66666610]">
                                        <input type="radio" wire:model="productType"
                                            class="text-blue-600 focus:ring-blue-500" value="Others">
                                        <span>Others</span>
                                    </label>
                                </div>
                                @error('productType')
                    ...
                    @else
                        {{-- <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mt-5">
                            ...
                            <div>
                                <label class="block text-gray-700 font-medium mb-1">
                                    Select Policy type <span class="text-red-600 text-lg">*</span>
                                </label>
                                <div class="flex space-x-5">
                                    <label class="flex items-center space-x-2 px-3 py-1 rounded-full bg-[#66666610]">
                                        <input type="radio" wire:model.live="excessType"
                                            class="text-blue-600 focus:ring-blue-500" value="Excess">
                                        <span>Nil Excess</span>
                                    </label>
                                    <label class="flex items-center space-x-2 px-3 py-1 rounded-full bg-[#66666610]">
                                        <input type="radio" wire:model.live="excessType"
                                            class="text-blue-600 focus:ring-blue-500" value="No Excess">
                                        <span>One month rent Policy Excess</span>
                                    </label>
                                </div>
                                @error('excessType')
                                    <span class="text-sm text-red-600 mt-1 block">{{ $message }}</span>
                            ...
                            @if ($excessType)
                                <div>
                                    <label class="block text-gray-700 font-medium mb-1">
                                        Select Monthly rental income cover <span class="text-red-600 text-lg">*</span>
                                    </label>
                                    <div class="flex space-x-5">
                                        <label
                                            class="flex items-center space-x-2 px-3 py-1 rounded-full bg-[#66666610]">
                                            <input type="radio" wire:model.live="excessAmount"
                                                class="text-blue-600 focus:ring-blue-500" value="0 - 1000">
                                            <span>Up to £1000</span>
                                        </label>
                                        <label
                                            class="flex items-center space-x-2 px-3 py-1 rounded-full bg-[#66666610]">
                                            <input type="radio" wire:model.live="excessAmount"
                                                class="text-blue-600 focus:ring-blue-500" value="1001 - 2000">
                                            <span>£1,001 to £2,000</span>
                                        </label>
                                        <label
                                            class="flex items-center space-x-2 px-3 py-1 rounded-full bg-[#66666610]">
                                            <input type="radio" wire:model.live="excessAmount"
                                                class="text-blue-600 focus:ring-blue-500" value="2001 - 3000">
                                            <span>£2,001 to £3,000</span>
                                        </label>
                        ...
                        <div class="grid grid-cols-1 {{ $excessType ? 'lg:grid-cols-3' : 'lg:grid-cols-1' }} gap-6 mt-5">
                            ...
                            <div class="lg:col-span-2">
                                ...
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                    ...
                                    <div>
                                        ...
                                        <div class="flex space-x-5">
                                            <label
                                                class="flex items-center space-x-2 px-3 py-1 rounded-full bg-[#66666610]">
                                                <input type="radio" wire:model.live="excessType"
                                                    class="text-blue-600 focus:ring-blue-500" value="Nil Excess">
                                                <span>Nil Excess</span>
                                            </label>
                                            <label
                                                class="flex items-center space-x-2 px-3 py-1 rounded-full bg-[#66666610]">
                                                <input type="radio" wire:model.live="excessType"
                                                    class="text-blue-600 focus:ring-blue-500" value="One month rent Policy Excess">
                                                <span>One month rent Policy Excess</span>
                                            </label>
                                        </div>
                                        @error('excessType')
                                    ...
                                    @if ($excessType)
                                        <div>
                                            <label class="block text-gray-700 font-medium mb-1">
                                                Select Monthly rental income cover <span
                            ...
                            <div class="bg-white shadow-md rounded-lg p-5 h-fit border">
                                ...
                                <div class="flex justify-between py-2 border-b">
                                    ...
                                    <span class="font-medium">£{{ number_format($premium ?? '', 2) }}</span>
                                </div>

                                <div class="flex justify-between py-2 border-b">
                                    <span class="text-gray-600">IPT</span>
                                    <span class="font-medium">£{{ number_format($ipt ?? '', 2) }}</span>
                                </div>

                                <div class="flex justify-between py-2 border-b">
                                    <span class="text-gray-600">Broker Fee</span>
                                    <span class="font-medium">£{{ number_format($brokerFee ?? '', 2) }}</span>
                                </div>

                                <div class="flex justify-between py-3 mt-2">
                                    <span class="font-semibold text-gray-800">Total Premium Due:</span>
                                    <span class="font-bold text-lg">
                                        £{{ number_format(($premium ?? '') + ($ipt ?? '') + ($brokerFee ?? ''), 2) }}
                                    </span>
                                </div>
                            ...
                            <div class="grid md:grid-cols-3 gap-4">
                                <div class="mb-2">
                                    ...
                                    <div class="flex items-center space-x-4">
                                        ...
                                        <div class="flex items-center">
                                            <input id="typeOfinsurancerenewal" type="radio"
                                                wire:model="insuranceType" value="renewal" class="mr-1">
                            ...
                            <div class="grid md:grid-cols-3 gap-4">
                                ...
                                <div class="mb-2">
                                    ...
                                    <input type="text" placeholder="Enter address..."
                                        wire:model.defer="addressOne" id="property_address"
                                        class="w-full border border-gray-300 rounded px-3 py-2 focus:outline-none focus:ring focus:ring-blue-200">
                                    @error('addressOne')
                                        <span class="text-sm text-red-600">{{ $message }}</span>
                                    @enderror
                ...
                <div id="tab3" class="tab-content bg-white p-6 rounded shadow">
                    <div class="grid grid-cols-1 gap-4 mt-6" x-data="{ policyHoldertype: @entangle('policyHoldertype') }">
                        ...
                        information. -->
                            ...
                            This is the person who will make the claim. If the property is managed, enter the managing
                            agent's information and whomever the tenancy agreement is under (Landlord name)
                        </p>
                        ...
                        <div class="grid md:grid-cols-3 gap-4">
                            @if ($productType != 'Agent')
                                <div>
                                    ...
                                    <div class="flex items-center space-x-4">
                                        ...
                                        <div class="flex items-center">
                                            <input id="policyHoldertypeThree" type="radio"
                                                x-model="policyHoldertype" value="Both" class="mr-1">
                            ...
                            @if (in_array($policyHoldertype, ['Company', 'Both']))
                                ...
                                <div x-show="policyHoldertype === 'Company'">
                                    <label class="block mb-1">Company email <span
                                            class="text-red-600">*</span></label>
                                    <input type="text" placeholder="Enter..."
                                        wire:model="policyholderCompanyEmail"
                                        class="w-full border border-gray-300 rounded px-3 py-2 focus:outline-none focus:ring focus:ring-blue-200">
                            ...
                            @if (in_array($policyHoldertype, ['Individual', 'Both']))
                                <div x-show="policyHoldertype === 'Individual'">
                                    <label class="block font-semibold mb-1">Title <span
                                            class="text-red-600">*</span></label>
                                ...
                                <div x-show="policyHoldertype === 'Individual'">
                                    <label class="block mb-1">Contact Email <span
                                            class="text-red-600">*</span></label>
                            ...
                            <div>
                                ...
                                <input type="number" placeholder="Enter..."
                                    wire:model="policyholderAlternativePhone"
                                    class="w-full border border-gray-300 rounded px-3 py-2 focus:outline-none focus:ring focus:ring-blue-200">
                            ...
                            <div>
                                ...
                                <input type="text" placeholder="Enter address..."
                                    wire:model="policyholderAddress1"
                                    class="w-full border border-gray-300 rounded px-3 py-2 focus:outline-none focus:ring focus:ring-blue-200">
                            </div>
                            ...
                            <div>
                                ...
                                <input type="text" placeholder="Enter address..."
                                    wire:model="policyholderAddress2"
                                    class="w-full border border-gray-300 rounded px-3 py-2 focus:outline-none focus:ring focus:ring-blue-200">
                            </div>
                            ...
                            <div>
                                ...
                                <p class="text-gray-500" style="font-size: 12px;">Enter email ids, separated by comma,
                                    if you need to send documents to additional people other than policy holder</p>
                    ...
                    <div class="space-y-4 mt-6">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                            ...
                            <div class="mb-2">
                                ...
                                <div class="flex items-center space-x-4">
                                    <div class="flex items-center">
                                        <input id="policyterm1" type="radio" wire:model="policyTerm"
                                            value="1" class="mr-1">
            ...
            @if ($currentStep === 5)
                <div id="tab5" class="tab-content bg-white p-6 rounded shadow">
                    <div class="space-y-4 mt-6">
                        <p class="font-semibold text-gray-800 text-lg mb-1">Tenant Details <small>(optional)</small>
                        </p>
                    ...
                    <div class="space-y-4 mt-6">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                            ...
                            <div>
                                ...
                                <p class="text-gray-500" style="font-size: 12px;">Enter email ids, separated by comma,
                                    if you need to send invoice to additional people other than billing email</p>
                            </div>
