                    ...
                    <div class="grid grid-cols-1 lg:grid-cols-3 gap-4">
                        ...
                        <label class="block">
                            ...
                            <input name="name" type="text" class="w-full mt-1 p-2 border rounded-md border-[#66666660]"
                                placeholder="Enter name" value="{{$insurance->name ?? ''}}">
                            @error('name')
                                <p class="text-theme-xs text-red-500 mt-1.5">{{ $message }}</p>
                            @enderror
                        </label>
                        ...
                        <label class="block">
                            ...
                            <input name="validity" type="text" class="w-full mt-1 p-2 border rounded" placeholder="Enter.."  value="{{$insurance->validity ?? ''}}">
                            @error('validity')
                                <p class="text-theme-xs text-red-500 mt-1.5">{{ $message }}</p>
                            @enderror
                        </label>
                        ...
                        <label class="block">
                            ...
                            <input name="rent_amount_from" type="text" class="w-full mt-1 p-2 border rounded" placeholder="Enter.."  value="{{$insurance->rent_amount_from ?? ''}}">
                        ...
                        <label class="block">
                            ...
                            <input name="rent_amount_to" type="text" class="w-full mt-1 p-2 border rounded" placeholder="Enter.."  value="{{$insurance->rent_amount_to ?? ''}}">
