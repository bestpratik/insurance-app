                              ...
                              @if ($row->offer)
                                  <span
                                      ...
                                      <svg xmlns="http://www.w3.org/2000/svg" fill="#ffffff" viewBox="0 0 640 640"
                                          style="width: 20px; display: inline-block; margin-right: 4px;"><!--!Font Awesome Free v7.0.0 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free Copyright 2025 Fonticons, Inc.-->
                                          <path
