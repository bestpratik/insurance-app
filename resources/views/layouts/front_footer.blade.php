    ...
    <div class="max-w-7xl mx-auto px-4 grid grid-cols-1 md:grid-cols-4 gap-10 text-sm">
        ...
        <div>
            ...
            <div class="flex space-x-3 mt-10">
                <a href="{{ $contact->link1 }}" aria-label="Facebook" class="hover:text-red-500"><svg xmlns="http://www.w3.org/2000/svg"
                ...
                <a href="{{ $contact->link3 }}" aria-label="LinkedIn" class="hover:text-red-500"><svg xmlns="http://www.w3.org/2000/svg"
                ...
                <a href="{{ $contact->link4 }}" aria-label="Instagram" class="hover:text-red-500"><svg xmlns="http://www.w3.org/2000/svg"
                        fill="currentColor" class="size-4" viewBox="0 0 24 24">
                        <path
