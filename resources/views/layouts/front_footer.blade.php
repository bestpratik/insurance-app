<footer class="bg-gray-900 text-white pt-14 pb-8">
    <div class="max-w-7xl mx-auto px-4 grid grid-cols-1 md:grid-cols-4 gap-10 text-sm">
        ...
        <div>
            ...
            <div>
                <form id="newsletterForm" class="flex">
                    ...
                    <input type="email" id="email_id" name="email_id" placeholder="Your Email ID"
                        class="w-full px-2 py-4 rounded-l bg-gray-800 text-white placeholder-gray-300 focus:outline-none">
                    <button type="submit" class="bg-red-600 hover:bg-red-700 text-white px-5 py-3 rounded-r">
                        SignUp
                    </button>
                </form>
            ...
            <div class="flex space-x-3 mt-10">
                <a href="{{ $contact->link1 }}" aria-label="Facebook" class="hover:text-red-500"><svg
                        xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 24 24" class="size-4">
                        <path
                ...
                <a href="{{ $contact->link2 }}" aria-label="Twitter" class="hover:text-red-500">
                ...
                <a href="{{ $contact->link3 }}" aria-label="LinkedIn" class="hover:text-red-500"><svg
                        xmlns="http://www.w3.org/2000/svg" fill="currentColor" class="size-4" viewBox="0 0 24 24">
                        <path
                ...
                <a href="{{ $contact->link4 }}" aria-label="Instagram" class="hover:text-red-500"><svg
                        xmlns="http://www.w3.org/2000/svg" fill="currentColor" class="size-4" viewBox="0 0 24 24">
                        <path
        ...
        <div>
            ...
            <ul class="space-y-2 text-gray-400 text-lg">
                ...
                <li class="flex items-center gap-2 hover:text-red-500">
                    ...
                    <a href="tel:{{ $contact->phone }}" class="text-gray hover:underline">
                        {{ $contact->phone }}
                    </a>
                </li>
                <li class="flex items-center gap-2 hover:text-red-500">
                    ...
                    <a href="mailto:{{ $contact->email }}" class="text-gray hover:underline">
                        {{ $contact->email }}
                    </a>
                </li>
            </ul>
        ...
        <div>
            ...
            <ul class="space-y-2 text-gray-400 text-lg">
                <li><a href="{{ route('home') }}"
                        class="{{ request()->routeIs('home') ? 'text-red-500 font-medium' : 'hover:text-red-500' }}">Home</a>
                </li>
                <li><a href="{{ route('about.us') }}"
                        class="{{ request()->routeIs('about.us') ? 'text-red-500 font-medium' : 'hover:text-red-500' }}">About
                        Us</a></li>
        ...
        <div>
            ...
            <ul class="space-y-2 text-gray-400 text-lg">
                <li><a href="{{ route('blogs', ['type' => 'blog']) }}"
                        class="{{ request()->is('blog*') ? 'text-red-500 font-medium' : 'hover:text-red-500' }}">
                        Blog
                    </a>
                </li>
                ...
                <li><a href="{{ route('terms.conditions') }}"
                        class="{{ request()->routeIs('terms.conditions') ? 'text-red-500 font-medium' : 'hover:text-red-500' }}">Terms
                        & Condition</a></li>
            </ul>
        </div>
    </div>
    ...
    <!-- Bottom Footer -->
    <div class="mt-10 border-t border-gray-700 pt-6 text-center text-gray-300 text-lg">
        © <span class="text-white underline">Moneywise Investments Plc</span>, All Rights Reserved.
    </div>
</footer>
