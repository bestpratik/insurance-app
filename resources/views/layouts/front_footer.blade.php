        ...
        <div class="max-w-7xl mx-auto px-4 grid grid-cols-1 md:grid-cols-4 gap-10 text-sm">
            ...
            <div>
                ...
                <div class="flex space-x-3">
                    <a href="#" class="hover:text-red-500"><svg xmlns="http://www.w3.org/2000/svg" fill="currentColor"
            ...
            <div>
                ...
                <ul class="space-y-2 text-gray-400 text-lg">
                    ...
                    <li><a href="#" class="hover:text-red-500">Our Services</a></li>
            ...
            <div>
                ...
                <form class="flex">
                    ...
                    <button class="bg-red-500 hover:bg-red-600 text-white px-4 rounded-r">SignUp</button>
                </form>
            </div>
        </div>
