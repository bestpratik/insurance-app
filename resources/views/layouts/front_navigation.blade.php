  <section class="bg-red-700 text-white text-sm px-6 py-3 flex justify-between items-center">
        <div class="flex items-center space-x-6">
            <div class="flex items-center space-x-3">
                ...
                <span class="hidden md:block">020 8552 5521</span>
            </div>
            <div class="flex items-center space-x-3">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                    stroke="currentColor" class="size-5">
                ...
                <span class="hidden md:block">enquiries@moneywiseplc.co.uk</span>
            </div>
            <div class="flex items-center space-x-3">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                    stroke="currentColor" class="size-5">
                ...
                <span class="hidden md:block">440-442, Romford Road, London, E7 8DF</span>
            </div>
        </div>
