...
<section class="bg-red-700 text-white text-sm px-6 py-3 flex justify-between items-center">
    ...
    <div class="flex space-x-5 items-center">
        <a href="{{ $contact->link1 }}" aria-label="Facebook" class="hover:text-red-500">
        ...
        <a href="{{ $contact->link3 }}" aria-label="LinkedIn" class="hover:text-red-500">
        ...
        <a href="{{ $contact->link4 }}" aria-label="Instagram" class="hover:text-red-500">
            <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" class="size-4" viewBox="0 0 24 24">
                <path
        ...
        <a href="{{ route('policy.referral.form') }}" class="hidden md:inline-block 2xl:hidden bg-white text-red-700 px-4 py-2 rounded-md font-semibold hover:bg-gray-100">
            Get a Quote
        </a>
    </div>
</section>
